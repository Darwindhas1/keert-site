...
DETAILS = [
    dict(
        ...
        gallery=[("seberang-jaya-card-700", 700, 525, "seberang-jaya-card-700",
    ...
    dict(
        ...
        items=["Sea and city skyline views",
               ...
               "Limited prime units"],
        gallery=[("gelugor-card-700", 700, 525, "gelugor-card-700",
    ...
    dict(
        ...
        list_head=None,
        items=None,
        gallery=[("seiras-card-1200", 1200, 900, "seiras-card-1200",
